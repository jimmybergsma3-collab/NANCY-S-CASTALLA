...
export function buildProductRow(product: SupplierImportProduct, productCode: string) {
  ...
  return {
    ...
    sales_unit_type: "",
    sales_unit_quantity: 0,
    sales_unit_confirmed: false,
    price_basis_confirmed: false,
    supplier_case_price: product.casePrice ?? 0,
    supplier_unit_price: product.unitPrice ?? product.priceExVat ?? 0,
    supplier_case_quantity: product.unitsPerCase ?? 0,
    source_package_text: product.packageDescription,
    stock_quantity: 0,
    minimum_stock: 0,
