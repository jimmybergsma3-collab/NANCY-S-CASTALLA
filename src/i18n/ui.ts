...
const categoriesEn: Record<ProductCategory, string> = {
  ...
  "Tex Mex & Convenience Food": "Tex Mex & Convenience Food",
  "Ready Meals": "Ready Meals",
  "Dutch / Belgian": "Dutch / Belgian",
  "Potato, Vegetable & Fruits": "Potato, Vegetable & Fruits",
...
const copies: Record<Locale, UiCopy> = {
  ...
  nl: {
    ...
    categories: {
      "Breakfast": "Ontbijt", "Pies & Pasties": "Pies & pasties", "Sunday Roast": "Sunday roast", "Bread": "Brood",
      "Finger Foods": "Finger foods", "Fish": "Vis", "Meat": "Vlees", "Barbecue & Grill": "Barbecue & grill",
      "Tex Mex & Convenience Food": "Tex Mex & convenience food", "Ready Meals": "Kant-en-klaar maaltijden", "Dutch / Belgian": "Dutch / Belgian",
      "Potato, Vegetable & Fruits": "Aardappel, groente & fruit", "Vegan & Vegetarian": "Vegan & vegetarisch", "Sauces": "Sauzen",
      "Tinned Food": "Blikproducten", "Baking & Cooking": "Bakken & koken", "Cakes & Desserts": "Cakes & desserts",
      "Snacks & Sweets": "Snacks & sweets", "Soft Drinks": "Frisdranken", "Alcoholic Drinks": "Alcoholische dranken", "Coffee & Tea": "Koffie & thee", "Non-food & Packaging": "Non-food & verpakkingen",
    },
  ...
  de: {
    ...
    categories: {
      "Breakfast": "Breakfast", "Pies & Pasties": "Pies & Pasties", "Sunday Roast": "Sunday Roast", "Bread": "Brot",
      "Finger Foods": "Finger Foods", "Fish": "Fisch", "Meat": "Fleisch", "Barbecue & Grill": "Barbecue & Grill",
      "Tex Mex & Convenience Food": "Tex Mex & Convenience Food", "Ready Meals": "Fertiggerichte", "Dutch / Belgian": "Dutch / Belgian",
      "Potato, Vegetable & Fruits": "Kartoffeln, Gemuese & Obst", "Vegan & Vegetarian": "Vegan & vegetarisch", "Sauces": "Saucen",
      "Tinned Food": "Konserven", "Baking & Cooking": "Backen & Kochen", "Cakes & Desserts": "Kuchen & Desserts",
      "Snacks & Sweets": "Snacks & Suesses", "Soft Drinks": "Softdrinks", "Alcoholic Drinks": "Alkoholische Getraenke", "Coffee & Tea": "Kaffee & Tee", "Non-food & Packaging": "Non-Food & Verpackungen",
    },
  ...
  es: {
    ...
    categories: {
      "Breakfast": "Desayuno", "Pies & Pasties": "Pies & pasties", "Sunday Roast": "Sunday roast", "Bread": "Pan",
      "Finger Foods": "Finger foods", "Fish": "Pescado", "Meat": "Carne", "Barbecue & Grill": "Barbacoa y grill",
      "Tex Mex & Convenience Food": "Tex Mex y comida preparada", "Ready Meals": "Platos preparados", "Dutch / Belgian": "Dutch / Belgian",
      "Potato, Vegetable & Fruits": "Patata, verdura y fruta", "Vegan & Vegetarian": "Vegano y vegetariano", "Sauces": "Salsas",
      "Tinned Food": "Conservas", "Baking & Cooking": "Hornear y cocinar", "Cakes & Desserts": "Tartas y postres",
      "Snacks & Sweets": "Snacks y dulces", "Soft Drinks": "Refrescos", "Alcoholic Drinks": "Bebidas alcoholicas", "Coffee & Tea": "Cafe y te", "Non-food & Packaging": "No alimentario y envases",
    },
  ...
  sv: {
    ...
    categories: {
      "Breakfast": "Frukost", "Pies & Pasties": "Pies & pasties", "Sunday Roast": "Sunday roast", "Bread": "Brod",
      "Finger Foods": "Finger foods", "Fish": "Fisk", "Meat": "Kott", "Barbecue & Grill": "Barbecue & grill",
      "Tex Mex & Convenience Food": "Tex Mex & convenience food", "Ready Meals": "Fardigratter", "Dutch / Belgian": "Dutch / Belgian",
      "Potato, Vegetable & Fruits": "Potatis, gronsaker & frukt", "Vegan & Vegetarian": "Veganskt & vegetariskt", "Sauces": "Saser",
      "Tinned Food": "Konserver", "Baking & Cooking": "Bakning & matlagning", "Cakes & Desserts": "Kakor & desserter",
      "Snacks & Sweets": "Snacks & sott", "Soft Drinks": "Laskedrycker", "Alcoholic Drinks": "Alkoholhaltiga drycker", "Coffee & Tea": "Kaffe & te", "Non-food & Packaging": "Icke-livsmedel & forpackningar",
    },
